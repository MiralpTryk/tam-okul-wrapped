<template>
    <div class="w-full">
        <div class="flex justify-center space-x-2 mt-4">
            <button @click="previousPage" class="p-2 bg-gray-300 rounded hover:bg-gray-400">
            ...
            <button @click="nextPage" class="p-2 bg-gray-300 rounded hover:bg-gray-400">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                    class="w-5 h-5">
    ...
    <div ref="mainContainer" class="flex flex-row mt-4 h-[488px] md:h-[560px] relative">
...
const totalPages = 5; // Adjust this based on your needs
